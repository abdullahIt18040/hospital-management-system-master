...
<div class="container-fluid">
  <div class="row mt-2">
       <div class="col-md-6 offset-md-4 admin" >
            <div class="card">
            ...
            <div class="row">   
                 <div class="form-group">
                     ...
                     <input type="text" class="form-control" id="manufacturedate" aria-describedby="emailHelp" name="manufacturedate" placeholder="Select Date.." required>
                 ...
                 <div class="form-group ml-4">
                     ...
                     <input type="text" class="form-control" id="expirydate" aria-describedby="emailHelp" name="expirydate" placeholder="Enter expiry date.." required>
                 </div>
            </div>
            <div class="row">     
                  <div class="form-group">
                     <label for="quantity">Quantity</label>
                     <input type="number" class="form-control" id="quantity" aria-describedby="emailHelp" name="quantity" placeholder="Enter quantity.." required>
                 </div>
                 
                 <div class="form-group ml-4">
                     <label for="price">Price</label>
                     <input type="number" class="form-control" id="price" aria-describedby="emailHelp" name="price" placeholder="Enter price.." required>
                 </div>
             </div>   
            <div class="row">     
                  <div class="form-group">
